module.exports = function (grunt) {
    ...
    grunt.initConfig({
            ...
            dist: {
                options: {
                    browserifyOptions: {
                        ...
                        standalone: 'MitchAllen.-marchio-datastore'
                        // standalone: 'mitchallen.-marchio-datastore'
                    },
                ...
                files: {
                   ...
                   "./dist/marchio-datastore.js": ["./modules/index.js"]
                   // For non-standalone, use ./browser.js instead.
                   // "./dist/marchio-datastore.js": ["./browser.js"]
                }
            }
        },
        ...
        uglify: {
            my_target: {
                files: {
                    './dist/marchio-datastore.min.js': ['./dist/marchio-datastore.js']
                }
            }
        },
